...
Web application for the Starter project.

**Package**: `@sudobility/starter_app` (private, BUSL-1.1)
...
- API URL: `.env` defaults to `localhost:8022` to match the API server (`starter_api`) -- verify `VITE_API_URL` matches your running API if using a different port
